...
function App() {
  ...
  let [products, setProducts] = useState([...product, ...dry, ...vege])
  const SearchHandler = (e) => {
    e.preventDefault()
    let searched = products.filter((x) => x.name.toLowerCase().includes(searchVal.toLowerCase()))
  ...
  return (
    <>
      <div>
        ...
        <Header SearchHandler={SearchHandler} setSearchVal={setSearchVal} username={username} count={cart.length} />
        <Routes>
          <Route path='/' element={<Home />} />
          <Route path='About' element={<About />} />
          <Route path='Contact' element={<Contact />} />
          <Route path='search' element={<Search searchedArray={searchedArray} addToCart={addToCart}/>} />
          ...
          <Route path='/login' element={<Register UserValue={UserValue} RegisterUser={RegisterUser} />} />
        </Routes>
